...
# Function adapted by Alejandro Hernandez Diaz to the Places365 Dataset
def load_image_ids(img_root):
    ''' This function takes the root of the image foler and traverses finding every image. 
        the id of every image depends on its location in the subdirectories 

        eg. a/airplane/00000002.jpg -> a-airplane-00000002
    '''
    pathXid = []
    ...
    for root, dirs, filenames in os.walk(img_root):
        ...
        for file in filenames:
            if file is not " ":
                idx = file.split(".")[0]
                identifier = os.path.join(root, idx).replace("/","-")
                pathXid.append(
                    (
...
def parse_args():
    ...
    parser.add_argument('--caffemodel', type=str, default='/mount/Implementation/Models/LXMERT/github/data/Places/resnet101_faster_rcnn_final_iter_320000.caffemodel')
...
if __name__ == '__main__':
    ...
    # Catching sigterm for checkpointing
